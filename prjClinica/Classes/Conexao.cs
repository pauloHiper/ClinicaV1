...
namespace prjClinica.Classes
{
    public class Conexao : System.Web.UI.Page, IDisposable
    {
        ...
        {
           return @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\prjClinica\prjClinica\App_Data\Database1.mdf;Integrated Security=True;Connect Timeout=30; Language = Portuguese";
        }
